...
class Conductor
{
    ...
    public static function mapBPMChanges(song:SwagSong)
    {
        ...
        var curStepCrochet:Float = calculateCrochet(curBPM) / 4;
        ...
        for (i in 0...song.notes.length)
        {
            if (song.notes[i].changeBPM && song.notes[i].bpm != curBPM)
            {
                ...
                curStepCrochet = calculateCrochet(curBPM) / 4;
                var event:BPMChangeEvent = {
                    stepTime: totalSteps,
                    songTime: totalPos,
                    bpm: curBPM,
                    stepCrochet: curStepCrochet
                };
            ...
            totalPos += curStepCrochet * deltaSteps;
        }
    }
